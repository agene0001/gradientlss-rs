...
use statrs::distribution::{Continuous, LogNormal as StatrsLogNormal};
...
impl LogNormal {
    ...
    fn log_prob_scalar(&self, params: &[f64], target: f64) -> f64 {
        ...
        match StatrsLogNormal::new(loc, scale) {
...
mod tests {
    ...
    fn test_log_normal_log_prob() {
        ...
        let expected = StatrsLogNormal::new(0.0, 1.0).unwrap().ln_pdf(1.0);
    ...
    fn test_log_normal_nll() {
        ...
        let expected_single = -StatrsLogNormal::new(0.0, 1.0).unwrap().ln_pdf(1.0);
